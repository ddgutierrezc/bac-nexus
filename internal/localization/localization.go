...
func catalogIDs() []string {
	return []string{
		...
		"form.fields", "form.footer", "form.label.credential_mode", "form.label.fingerprint", "form.label.host", "form.label.java_home", "form.label.mapepire_jar", "form.label.name", "form.label.port", "form.label.trust", "form.label.username",
		...
		"onboarding.title", "onboarding.description", "onboarding.host", "onboarding.username", "onboarding.connect", "onboarding.footer", "onboarding.validation", "onboarding.unavailable", "onboarding.prompt_failed", "onboarding.running", "onboarding.cancel", "onboarding.failed", "onboarding.failed_cleanup", "onboarding.saved", "onboarding.finalize",
	}
}
