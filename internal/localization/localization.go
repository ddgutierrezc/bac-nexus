...
func catalogIDs() []string {
	return []string{
		...
		"onboarding.upload_stage", "onboarding.upload_stage.remote_home", "onboarding.upload_stage.directory_prepare", "onboarding.upload_stage.inspect_existing", "onboarding.upload_stage.create_temporary", "onboarding.upload_stage.transfer", "onboarding.upload_stage.secure_temporary", "onboarding.upload_stage.verify_temporary_hash", "onboarding.upload_stage.backup", "onboarding.upload_stage.activate", "onboarding.upload_stage.verify_activated", "onboarding.upload_stage.cleanup_rollback",
	}
}
