...
const (
	...
	ResultLaunchReceiptBindingInvalid        ResultClass = "launch_receipt_binding_invalid"
	ResultLaunchReverifyStatFailure          ResultClass = "launch_reverify_stat_failure"
	ResultLaunchReverifyArtifactInvalid      ResultClass = "launch_reverify_artifact_invalid"
	ResultLaunchReverifyOpenFailure          ResultClass = "launch_reverify_open_failure"
	ResultLaunchReverifyReadFailure          ResultClass = "launch_reverify_read_failure"
	ResultLaunchReverifySizeChanged          ResultClass = "launch_reverify_size_changed"
	ResultLaunchReverifyHashMismatch         ResultClass = "launch_reverify_hash_mismatch"
	ResultLaunchCommandPolicyFailure         ResultClass = "launch_command_policy_failure"
	ResultLaunchNewSessionProhibited         ResultClass = "launch_new_session_prohibited"
	ResultLaunchNewSessionConnectionFailed   ResultClass = "launch_new_session_connection_failed"
	ResultLaunchNewSessionUnknownChannelType ResultClass = "launch_new_session_unknown_channel_type"
	ResultLaunchNewSessionResourceShortage   ResultClass = "launch_new_session_resource_shortage"
	ResultLaunchNewSessionFailure            ResultClass = "launch_new_session_failure"
...
func IsTerminalResult(c ResultClass) bool {
	switch c {
	case ResultIdentityFailure, ResultTrustMismatch, ResultProtocolFailure, ResultFramingFailure, ResultMalformedResponse, ResultDowngradeBlocked, ResultCredentialsUnavailable, ResultAuthenticationFailed, ResultAuthorizationDenied, ResultCancelled, ResultOperationTimeout, ResultProofTimeout, ResultCleanupTimeout, ResultCleanupFailure, ResultLimitExceeded, ResultConsentDeclined, ResultArtifactFailure, ResultJavaFailure, ResultUploadFailure, ResultLaunchFailure, ResultLaunchReceiptBindingInvalid, ResultLaunchReverifyStatFailure, ResultLaunchReverifyArtifactInvalid, ResultLaunchReverifyOpenFailure, ResultLaunchReverifyReadFailure, ResultLaunchReverifySizeChanged, ResultLaunchReverifyHashMismatch, ResultLaunchCommandPolicyFailure, ResultLaunchNewSessionProhibited, ResultLaunchNewSessionConnectionFailed, ResultLaunchNewSessionUnknownChannelType, ResultLaunchNewSessionResourceShortage, ResultLaunchNewSessionFailure, ResultLaunchSessionFailure, ResultLaunchStdinFailure, ResultLaunchStdoutFailure, ResultLaunchStartFailure, ResultSessionFailure, ResultProofFailure:
		return true
	}
	return false
}
