...
- [ ] 2.8 **RED (PR 3B.1b)**: Test complete local root/permission/symlink/reparse/network defenses, cancellable 25/50/100ms retries, ambiguous-COMMIT exact readback, bounded quick/proportional integrity checks, and cross-process contention. Await corrected independent GitHub Actions RED evidence.
